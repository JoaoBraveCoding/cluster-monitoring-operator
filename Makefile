...
.PHONY: docs
docs: $(EMBEDMD_BIN) Documentation/telemetry/telemeter_query  Documentation/config.md
...
Documentation/config.md: $(PANDOC_BIN) Documentation/config.adoc
	podman run -v ${PWD}/Documentation:/documents/:z docker.io/asciidoctor/docker-asciidoctor asciidoctor -b docbook config.adoc
	podman run -v ${PWD}/Documentation:/data:z docker.io/pandoc/core -f docbook -t markdown_strict config.xml -o config.md
	rm -f Documentation/config.xml 
